...
Using the powerful *Keras* package, we create a network with five dense layers with the following units: 256, 1024, 512, 256, 1 (output layer). And a dropout rate of 0.1 that helps to reduce overfitting. The network ends with a single unit to predict a single continuous value of Sales Prices.
