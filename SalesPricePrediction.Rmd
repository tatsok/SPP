...
Now let's train the final deep learning model with the best parameters (in this case, the number of epochs is 70). *Please note that when testing on GPU, the model yields a better result. The result discussed in this study was produced on CPU as proof of concept only. GPU use is highly recommended.*
